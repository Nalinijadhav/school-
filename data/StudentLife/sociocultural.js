import Dronasagar1 from "../../images/StudentLife/Sociocultural/Dronasagar1.webp";
import Dronasagar2 from "../../images/StudentLife/Sociocultural/Dronasagar2.webp";
import Dronasagar3 from "../../images/StudentLife/Sociocultural/Dronasagar3.webp";
...
import street from '../../images/StudentLife/Sociocultural/streets.webp'
...
export const socioculturalData = [
  {
  ...
  },
  {
    ...
    tabs: [
      {
        name: "Dronasagr-A hydrological Disconnect",
        h3: "Dronasgar-A hydrological Disconnect",
        sliderImages: [Dronasagar1, Dronasagar2, Dronasagar3],
        additionalParagraph: [
          {
            name: "Introduction",
            Tabpara: [
      ...
      },
      {
        name: "Streets for Me",
        h3: "Streets for Me",
        images: [{ image: street, tag: "Sustainable Cities and Development" }],
        additionalParagraph: [
          {
            name: "Introduction",
            Tabpara: [
          ...
          },
          {
            ...
            paraImage: "",
            paralist:[{liTitle:"Observe",liHeading:"Observe who and what constitute your city and understand its functions. Observing the surroundings using all your 5 senses",liList:["What do you see, What are the different sounds, What do the different smells tell us","How do you feel when you connect with the social fabric and can you elaborate on the Flavours of the city with the change in season/function",]},
        {liTitle:"Relate",liHeading:"Mapping the observations during the visits to the location on a digital map.",liList:["Relating your city with other similar cases by understanding their methodologies and best practices keeping in mind the SDG goals","Categorizing stakeholders and assessing their integration in the social fabric to promote sustained, inclusive and sustainable growth"]},
        {liTitle:"Design",liHeading:"Creating goals for a sustainable growth for an inclusive society",liList:["Transport – Sustainable transport by ensuring convenience in using public transport and by promoting walking and cycling for last mile connectivity.","Management of resources - Sustainable land-use planning and management while integrating provision of environmental infrastructure: water, sanitation, drainage and solid waste management."]},
        {liTitle:"Action",liHeading:"Creating a sustainable solution",liList:["Addressing the local authorities of the issues identified asking for action to be taken","Collaborating with the community to promote Sustainable practice and implementation of design through presentations, art, street play, etc"]},
        {liTitle:null,liHeading:["(See Map ). They were asked to work on the key concept of \"Streets for Me\" by collecting data from secondary sources, interviewing people, analysis and presentations in various formats. The workshop consisted of a series of online interactions between students and facilitators. In the first interaction the facilitators gave an overview of the objectives and expectations from the workshop. It was followed by 5 more interactions whereby students came up with their ideas, discussed their workplan and were given due suggestions and feedback on focus, content and delivery.","The final submission consisted of two components. In the first part, students created a story about their part of the street and presented it online along with their plan for creating the offline artifact. On October 2, 2021, fourteen teams presented their final work on the main street in the form of street plays, posters, props and artifacts spreading the message of inclusive, safe, and sustainable streets. In the final event, teams from prominent NGOs and civil society organizations also participated. The final results were a cumulative score of both online and offline presentations along with the score of the stakeholders from various walks of life, who were an integral part of the live voting process. The winners were felicitated and special mentions were given to three teams for overall efforts."],liList:[]}  
    ],
      ...
      {
        name: "Sustainability-A way of life",
        h3: "Sustainability-A way of life",
