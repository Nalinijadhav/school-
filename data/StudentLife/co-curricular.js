import ICT from '../../images/StudentLife/cocurricular/ict.webp'
import Arts from '../../images/StudentLife/cocurricular/arts.webp'
import Publications from '../../images/StudentLife/cocurricular/publications.webp'
import Music from '../../images/StudentLife/cocurricular/music.webp'
import Quiz from '../../images/StudentLife/cocurricular/quiz.webp'
...
import Archanak from '../../images/StudentLife/cocurricular/archana_khanna.webp'
...

    {
      ...
      },
      {
        ...
        "There are endless benefits to learning to sing (effectively expressing emotion, learning new cultures and languages, and becoming a more collaborative musician), and the school time is the best time to begin so we as faculty members are giving our best to make our students more confident and skilled."],
                teachers:[
                    {name:"Ms. ARCHANA KHANNA",image:Archanak},
            ...
            },
            {
                ...
                images:[Quiz],
                additionalParagraph:[
                "In the world of education, there are many different ways to teach and to consolidate what has been learned. One such tool which is quite common, in education is quizzes. It helps to build concentration, identify gaps in knowledge and help children to retain information.",
                ...
                "Most children find that quizzes are fun. Children of all ages love playing quizzes and with education thrown in, they will learn a lot while enjoying themselves.", 
                     ],
                teachers:[
